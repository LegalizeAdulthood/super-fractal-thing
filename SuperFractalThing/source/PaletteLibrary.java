...
public class PaletteLibrary implements ActionListener
{
	static String[] sLibrary=
		...
		"sft_palette" + "\n" +
				...
				"7" + "\n" +
				"4,100.0,0.1480,1.0,2.5132741228718345,0.0,0.899" + "\n" +
				"4,100.0,0.1000,0.625,0.0,0.58,0.899" + "\n" +
				"3,100.0,0.7170,1.0,3.078760800517997,0.321,0.823" + "\n" +
				"0" + "\n" +
				"0,10.00000149011612,0.4380,1.0,0.0,0.0,0.5" + "\n" +
				"0,100.0,0.1000,1.0,1.6838936805725098,0.3959999978542328,0.5" + "\n" +
				"0,00.9999999776482582,0.3700,1.0,2.6766369342803955,0.47200000286102295,0.5" + "\n" +
				"0" + "\n" +
				"0,00.9999999776482582,0.4310,1.0,1.7278759479522705,0.0,0.5" + "\n" +
				"0,100.0,0.1000,1.0,2.2053980827331543,0.0,0.5" + "\n" +
				"0,00.9999999776482582,0.8120,1.0,4.24114990234375,0.4909999966621399,0.5" + "\n" +
				"7" + "\n" +
				"0,100.0,0.0500,0.2529999911785126,2.4630086421966553,0.6230000257492065,0.5" + "\n" +
				"0,100.0,0.1000,1.0,0.0,0.0,0.5" + "\n" +
				"1,100.00000149011612,0.8530,1.0,2.060884714126587,0.0,0.3659999966621399" + "\n" +
				"0" + "\n" +
				"0,100.0,0.1000,1.0,0.0,0.0,0.5" + "\n" +
				"0,100.0,0.1000,1.0,0.0,0.0,0.5" + "\n" +
				"0,100.0,0.1000,1.0,0.0,0.0,0.5" + "\n" +
